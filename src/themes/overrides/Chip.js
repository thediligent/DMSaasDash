    ...
    MuiChip: {
      styleOverrides: {
        root: {
          ...
          '&.MuiChip-colorPrimary': getColor({ color: 'primary', backgroundColor: '#071b2bd9', theme }),
          ...
          '&.MuiChip-colorWarning': getColor({ color: 'warning', backgroundColor: '#63550a33', theme })
        },
        sizeLarge: {
          fontSize: '1rem',
          height: 40
        ...
        light: {
          ...defaultLightChip,
          '&.MuiChip-lightPrimary': getColorStyle({ color: 'primary', backgroundColor: '#071b2bd9', theme }),
          ...
          '&.MuiChip-lightWarning': getColorStyle({ color: 'warning', backgroundColor: '#63550a33', theme })
        },
        combined: {
          border: '1px solid',
          ...defaultLightChip,
          '&.MuiChip-combinedPrimary': getColorStyle({ color: 'primary', backgroundColor: '#071b2bd9', theme }),
          ...
          '&.MuiChip-combinedWarning': getColorStyle({ color: 'warning', backgroundColor: '#63550a33', theme })
        }
      }
    }
  };
